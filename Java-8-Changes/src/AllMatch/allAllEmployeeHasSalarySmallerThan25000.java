...
public class allAllEmployeeHasSalarySmallerThan25000 {
	...
	public static void main(String[] args) {
		...
		empList.add(new Employee("Vikas", 38, "Administration", 66000));
		 ...
		 boolean flag =empList.stream().allMatch(emp->emp.getSalary()<25000);
		 
		 if (flag == true) {

				System.out.println("all employees have a smaller than 25000");
			} else {

				System.out.println("all employees not have a smaller than 25000");
			}
	}
