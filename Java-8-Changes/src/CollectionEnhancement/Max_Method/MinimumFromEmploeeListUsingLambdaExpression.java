package CollectionEnhancement.Max_Method;
...
public class MinimumFromEmploeeListUsingLambdaExpression {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Name of employee whose salary is maximum>>\n");
        ...
        // Print the name of the employee with the maximum salary
        if (maxSalaryEmployee != null) {
            System.out.println(maxSalaryEmployee.getEmpName());
        } else {
