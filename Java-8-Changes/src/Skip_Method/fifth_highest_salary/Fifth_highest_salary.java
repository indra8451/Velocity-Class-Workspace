package Skip_Method.fifth_highest_salary;

import java.util.ArrayList;
import java.util.List;

public class Fifth_highest_salary {
	...
	public static void main(String[] args) {
		...
		}).skip(3).limit(1).forEach(emp->System.out.println(emp));
		

	}

}
// here why 3 so 0-3 means 4 and pickup next one record so 1